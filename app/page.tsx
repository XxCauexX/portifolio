          ...
          <div className="container px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex justify-center">
                <div className="relative w-64 h-64 rounded-full overflow-hidden border-4 border-background">
                  <img
                    src="/perfil.jpeg"
                    alt="Profile"
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-3xl">
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">caue.a.505@gmai.com</p>
                </a>
                <a
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">@XxCauexX</p>
                </a>
                <a
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">Cauê de Andrade</p>
                </a>
              </div>
            </div>
          </div>
